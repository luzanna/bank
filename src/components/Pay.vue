        ...
        <div class="pay-block">
            ...
            <div class="info">
                <div class="pay-info">
                    ...
                    <div class="pay-info-block">
                        <input class="data" maxlength="16" minlength="16" pattern="[0-9]{16}" v-model.lazy="bankAccount">
                        <input class="data" minlength="1" pattern="[0-9]{1,}" v-model.lazy="price">
<!--                        <label>руб.</label>-->
                    </div>
                </div>
            </div>
        ...
        <div class="both-card">
            <div class="card-data">
                ...
                <input class="number-card-enter" maxlength="4" minlength="4" pattern="[0-9]{4}" v-model="card1">
                <input class="number-card-enter" maxlength="4" minlength="4" pattern="[0-9]{4}" v-model="card2">
                <input class="number-card-enter" maxlength="4" minlength="4" pattern="[0-9]{4}" v-model="card3">
                <input class="number-card-enter" maxlength="4" minlength="4" pattern="[0-9]{4}" v-model="card4">  <br>
                ...
                <br>
                <input class="name" placeholder="Держатель карты" minlength="4"
                       pattern="^[a-zA-Z\s]+$"
                       v-model.lazy="payer">
            </div>
            <div class="private-info card-data">
                ...
                <input class="cvc" placeholder="?" maxlength="3" minlength="3"  pattern="[0-9]{3}" v-model="cvc">
            </div>
        </div>
            <button type="submit" class="pay-button" v-on:click="checkData"> Оплатить </button>
        </div>
        <div class="text-info">
            <p>
    ...
    export default {
        ...
        methods:{
            ...
            checkData(){
                ...
                if (this.card1 && this.card2 && this.card3 && this.card4 &&
                    this.selectDay && this.selectYear && this.payer && this.cvc &&
                    this.price && this.bankAccount){
